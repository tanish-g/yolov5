...
def run(data,
    ...
    iouv = torch.linspace(0.3, 0.8, 5).to(device)  # iou vector for mAP@0.5:0.95
    niou = iouv.numel()
    ...
    s = ('%20s' + '%11s' * 7) % ('Class', 'Images', 'Labels', 'P', 'R', 'mAP@.5', 'mAP@0.3:0.8','F2@0.3:0.8')
    ...
    if len(stats) and stats[0].any():
        ...
        mp, mr, map50, map , f2 = p.mean(), r.mean(), ap50.mean(), ap.mean() , f2.mean()
